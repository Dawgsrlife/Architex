...
const mockPublicProjects: PublicProject[] = [
  { 
    ...
    description: "Complete microservices architecture for e-commerce with payment processing, inventory management, and user authentication",
    author: { name: "Sarah Chen", avatar: "https://i.pravatar.cc/150?u=sarah" },
    nodesCount: 15, 
    stars: 234,
    views: 1520,
    updatedAt: "2 hours ago", 
    tags: ["microservices", "e-commerce", "stripe"],
    githubUrl: "https://github.com/sarahchen/ecommerce-arch",
    vercelUrl: "https://ecommerce-demo.vercel.app"
  },
  { 
    id: "2", 
    name: "Real-time Chat System", 
    description: "Scalable chat architecture with WebSocket connections, message queuing, and presence detection",
    ...
    githubUrl: "https://github.com/alexrivera/chat-system",
    vercelUrl: "https://chat-demo.vercel.app"
  },
  { 
    id: "3", 
    name: "AI Content Pipeline", 
    description: "ML pipeline for content generation with GPT integration, image processing, and content moderation",
    author: { name: "James Park", avatar: "https://i.pravatar.cc/150?u=james" },
    nodesCount: 18, 
    stars: 312,
    views: 2100,
    updatedAt: "1 day ago", 
    tags: ["ai", "ml", "openai", "content"],
    githubUrl: "https://github.com/jamespark/ai-pipeline"
  },
  { 
    id: "4", 
    name: "IoT Dashboard", 
    description: "IoT device management platform with real-time monitoring, alerts, and data visualization",
    author: { name: "Emma Wilson", avatar: "https://i.pravatar.cc/150?u=emma" },
    nodesCount: 9, 
    stars: 156,
    views: 720,
    updatedAt: "2 days ago", 
    tags: ["iot", "mqtt", "timeseries"],
    githubUrl: "https://github.com/emmawilson/iot-dash",
    vercelUrl: "https://iot-dashboard.vercel.app"
  },
  { 
    id: "5", 
    name: "Video Streaming Platform", 
    description: "Video on demand architecture with transcoding, CDN distribution, and adaptive bitrate streaming",
    author: { name: "Michael Lee", avatar: "https://i.pravatar.cc/150?u=michael" },
    nodesCount: 21, 
    stars: 445,
    views: 3200,
    updatedAt: "3 days ago", 
    tags: ["video", "cdn", "streaming", "aws"],
    githubUrl: "https://github.com/michaellee/video-platform"
  },
  { 
    id: "6", 
    name: "Multi-tenant SaaS", 
    description: "SaaS boilerplate with tenant isolation, billing integration, and role-based access control",
    author: { name: "Lisa Zhang", avatar: "https://i.pravatar.cc/150?u=lisa" },
    nodesCount: 14, 
    stars: 278,
    views: 1850,
    updatedAt: "4 days ago", 
    tags: ["saas", "multi-tenant", "rbac"],
    githubUrl: "https://github.com/lisazhang/saas-template",
    vercelUrl: "https://saas-demo.vercel.app"
  },
];

const allTags = ["all", "microservices", "ai", "e-commerce", "real-time", "iot", "saas", "video", "streaming"];
        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center gap-1">
              <Link href="/dashboard" className="px-4 py-2 text-sm text-stone-500 hover:text-stone-900 transition-colors">
                Dashboard
              </Link>
              <Link href="/explore" className="px-4 py-2 text-sm text-stone-900 font-medium">
                Explore
              </Link>
...
export default function ExplorePage() {
  ...
  const filteredProjects = mockPublicProjects
    .filter(p => {
        ...
        <div className="max-w-7xl mx-auto">
          <div ref={headerRef} className="text-center mb-12">
            ...
            <p className="text-stone-500 text-lg max-w-2xl mx-auto">
              Discover and learn from public system designs. Clone, modify, and deploy community-built architectures.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 mb-8">
            <div className="flex items-center gap-3 w-full lg:w-auto">
              <div className="relative flex-1 lg:flex-none">
                ...
                <input
                  ...
                  className="w-full lg:w-80 pl-9 pr-4 py-2.5 bg-white border border-stone-200 rounded-xl text-stone-900 placeholder-stone-400 text-sm focus:outline-none focus:ring-2 focus:ring-stone-900/5 focus:border-stone-300 transition-all"
                />
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <select
                ...
                className="px-3 py-1.5 bg-white border border-stone-200 rounded-lg text-stone-600 text-xs font-medium focus:outline-none"
              >
