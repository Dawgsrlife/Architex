        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 lg:gap-12 mb-20">
          ...
          <div className="footer-col">
            ...
            <ul className="space-y-3">
              <li><Link href="/dashboard" className="text-sm text-stone-400 hover:text-white transition-colors">Dashboard</Link></li>
              <li><Link href="/workflow" className="text-sm text-stone-400 hover:text-white transition-colors">Architecture Canvas</Link></li>
              <li><a href="#work" className="text-sm text-stone-400 hover:text-white transition-colors">Examples</a></li>
          ...
          <div className="footer-col">
            ...
            <ul className="space-y-3">
              <li><a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-sm text-stone-400 hover:text-white transition-colors">GitHub Repository</a></li>
              <li><a href="/README.md" className="text-sm text-stone-400 hover:text-white transition-colors">Documentation</a></li>
              <li><a href="/API.md" className="text-sm text-stone-400 hover:text-white transition-colors">API Reference</a></li>
            </ul>
          </div>
        </div>
